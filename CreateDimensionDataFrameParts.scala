...
// MAGIC 
// MAGIC try:
// MAGIC   sourceZip= "CubeSourceDataFile/hydrogridthsweghted/THSweighted.zip"
// MAGIC 
// MAGIC   #extract the files in 
// MAGIC   zipPath = "/dbfs/mnt/trainingDatabricks/" +  sourceZip
// MAGIC   folderName = "/".join(sourceZip.split("/")[:-1])
...
// MAGIC %scala
// MAGIC 
// MAGIC val sourceFile= new File("/dbfs/mnt/trainingDatabricks/CubeSourceDataFile/hydrogridthsweghted/CZ_EU_2012.zip")
// MAGIC val destination= new File("/dbfs/mnt/trainingDatabricks/CubeSourceDataFile/hydrogridthsweghted")
// MAGIC 
// MAGIC unZip(sourceFile,destination)
...
// MAGIC /*
// MAGIC x,
// MAGIC floor(x/100) * 100 as x1,
// MAGIC y,
// MAGIC floor(y/100) * 100 as y1,
// MAGIC */
// MAGIC *
// MAGIC 
// MAGIC 
// MAGIC from jedi_dimensions.d_n2k_2021typecnet10m_886_202251_10m
// MAGIC /*
// MAGIC select 
// MAGIC --N2k_2021_type_C_sitecode
// MAGIC 
// MAGIC gridnums.gridnum & cast(-65536 as bigint) as GridNum,
// MAGIC if (sum(areaha) > 0.5,1) as  
// MAGIC if (sum(areaha) > 0.5,1) as  area_ha
// MAGIC round(SUM(areaHa),2) as protected_area_N2k_2021_type_c_ha,
// MAGIC gridnums.gridnum & cast(-4294967296 as bigint) as GridNum10km
// MAGIC 
// MAGIC from jedi_dimensions.d_n2k_2021typecnet10m_886_202251_10m
// MAGIC group by 
// MAGIC   gridnums.gridnum & cast(-65536 as bigint),
// MAGIC   gridnums.gridnum & cast(-4294967296 as bigint)
// MAGIC */
// MAGIC where gridnum10km=9436442581270528
// MAGIC limit 100

// COMMAND ----------

// MAGIC %sql
// MAGIC drop table jedi_cubes.f_freshwater_cube_10m
